...
const MainBanner = () => {
  return (
    <div className='relative'>
      <img src={assets.main_banner_bg} alt='banner' className='w-full hidden md:block rounded-md ' />
      <img src={assets.main_banner_bg_sm} alt='banner' className='w-full md:hidden rounded-md ' />
